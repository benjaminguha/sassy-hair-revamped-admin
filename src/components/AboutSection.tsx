    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            <h2 className="text-4xl font-cursive font-bold text-primary mb-6">We're Changing the Way People Think About Hair</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            ...
            <div className="text-center">
              <p className="text-xl font-cursive font-semibold text-primary mb-2">Bec & Dan</p>
        ...
        <div className="text-center bg-gray-50 rounded-lg p-12">
          <h3 className="text-3xl font-cursive font-bold text-primary mb-6">KEUNE, THROUGH & THROUGH</h3>
